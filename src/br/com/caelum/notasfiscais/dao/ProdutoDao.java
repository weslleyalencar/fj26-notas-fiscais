...
public class ProdutoDao implements Serializable{
	...
	public List<Produto> listaTodosOrdenadoPorNome() {
		 List<Produto> lista = manager.createQuery("select p from Produto p order by p.nome ", Produto.class).getResultList();
		 return lista;
	}
